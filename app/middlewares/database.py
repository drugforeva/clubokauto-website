    ...
    async def __call__(
        ...
        async with self.session_factory() as session:
            ...
            try:
                ...
                raise
            # Обработчик мог закоммитить сам, чтобы не держать транзакцию
            # открытой во время отправки в Telegram. Пустой commit на закрытой
            # транзакции — лишний раундтрип к базе.

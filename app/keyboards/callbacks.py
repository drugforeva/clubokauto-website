...
class MenuCB(CallbackData, prefix="m"):
    """Главное меню: home | history | search | stats | settings | export | help."""
...
class SearchCB(CallbackData, prefix="f"):
    """Поиск: open | query | sender | date_from | date_to | reset | run | page | show."""
...
class SettingsCB(CallbackData, prefix="s"):
    """Настройки: open | toggle | timezone | retention | set_retention."""

...
COMMANDS: tuple[BotCommand, ...] = (
    BotCommand(command="start", description="Меню и подключение"),
...
def build_services(
    *,
    ...
    downloader = FileDownloader(bot, storage, settings.max_download_bytes)
    ...
    return {
        ...
        "retention": RetentionService(
            session_factory, storage, sweep_hours=settings.retention_sweep_hours
        ),
    }
